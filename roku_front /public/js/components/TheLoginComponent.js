export default {
    ...
    <section class="container">
        ...
        <div class="login">
            <h3>User Login</h3>
            <label class="text-input" for="inlineFormInputName">
                <i class="ri-user-fill"></i>
                <input ref="username" v-model="username" type="text" class="form-control" id="inlineFormInputName" type="text" placeholder="username" required>
            </label>
            <label class="text-input" for="inlineFormPassword">
                <i class="ri-lock-fill"></i>
                <input type="password" ref="password" v-model="password" type="password" class="form-control" id="inlineFormPassword" placeholder="password" required>
            </label>
            <buton @click="tryLogIn" type="submit" class="login-btn">LOGIN</buton>
            <a href="#" class="forgot"> Forgot Username/Password?</a>
            <div v-if="signUp" @click="trySignUp" type="submit" class="create">
                <a href="#">Create Your Account</a>
                <i class="arrow-right-fill"></i>
            </div>
        </div>
    </section>
    ` ,
